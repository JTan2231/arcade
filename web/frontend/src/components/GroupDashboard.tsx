...
type LoadFeedOutputSummaries = (selectedDate: string, signal: AbortSignal) => Promise<DailyFeedOutputSummary[]>;
...
function feedOutputSummary(output: DailyFeedOutput): DailyFeedOutputSummary {
...
function outputItemDisplayTitle(item: DailyFeedOutputItem): string {
